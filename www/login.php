...
function do_login() {
	...
	if ($previous_login_failed < 3 && empty($_POST["processlogin"]) && empty($_COOKIE['u'])) {
		...
		echo '<p>'._('Toda tu información como usuario está disponible desde la página de tu perfil. También puedes subir una imagen que representará a tu usuario en roséame').'.</p>'."\n";
		echo '</li>'."\n";
		/*echo '<li>'."\n";
		...
		echo '</li>'."\n";*/
		echo '</ul>'."\n";
		echo '<h3><a href="register.php" style="color:#AB3166; text-decoration:underline; display:block; width:8em; text-align:center; margin:0 auto; padding:0.5em 1em; border:3px double #AB3166; background:#FFE4E1;">Regístrate ahora</a></h3>'."\n";
		echo '</div>'."\n";
