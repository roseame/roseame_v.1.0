...
$globals['site_name'] = 'Roséame';
$globals['site_shortname'] = 'rsm'; //Used to differentiate in keys
$globals['v'] = 8; // internal version, to for reloads
$globals['lang'] = $dblang	= 'es';

$globals['help_url'] = 'http://www.roseame.net/faq-es.php';
...
$globals['email_domain'] = 'your.email.server'; // Used for sending emails from web.
$globals['email_user'] = 'user@email.com';
$globals['email_password'] = 'mailpassword';
...
$globals['db_password'] = 'dbpassword';
...
$globals['base_url'] = '/';
$globals['top_logo'] = 'img/mnm/rsm.png';
$globals['thumbnail_logo'] = 'img/mnm/rsm_thumbnail.png';
...
$globals['user_agent'] = 'Roseamebot (http://www.roseame.net/)';
...
if (!isset($globals['basic_config']) || !$globals['basic_config']) {
	...
	ini_set("include_path", '.:'.mnminclude.':'.mnmpath .':/usr/share/php');
