...
<p>No te olvides de leer las <a href="http://www.roseame.net/legal.php">condiciones de uso</a>.</p>
</li>
...
<p>No, cuentan también el <em>karma</em>, si es voto anónimo o no, y el número de <em>problemas</em> reportados (similar a votos negativos). 
</p>
</li>
...
<p>Las que tú desees relacionadas con el mundo del corazón, pero sigue leyendo. Estarán sujetas a la revisión de los lectores que las votarán, o no. Aún así, el objetivo principal es que se traten de noticias y apuntes de blogs relacionados con la prensa rosa. Lo que <strong>no debes hacer es <em>spam</em></strong>, es decir enviar muchos enlaces de unas pocas fuentes. Intenta ser variado. Envía historias que puedan ser interesantes para muchos. No mires sólo tu ombligo, usa el <strong>sentido común y un mínimo de espíritu colaborativo y respeto hacia los demás</strong>.
</p>
</li>
...
<p>Hace falta un karma mínimo para votar negativo y otro para cualquier voto a los comentarios.</p>
</li>
...
<li id="<? echo "q$q";$q++;?>">
<h4>¿Por qué es tan similar a Menéame?</h4>

<p>El código de roséame esta basado en la version 4.0 del código de menéame porque era un buen punto de partida, la interfaz e interacción con el usuario era simple y efectiva. ¿Por qué reinventar la rueda desde cero si ya está bastante redonda?</p>
...
<p><a href="https://github.com/roseame/roseame_v.1.0/">Ya está liberado</a>. En el pie de todas las páginas encontrarás el enlace para descargarlo. Tiene la licencia <a href="http://www.affero.org/oagpl.html">Affero General Public License</a>.</p>
</li>
...
<p>Ver la <a href="http://www.roseame.net/legal.php#contact">sección de contacto</a> en la condiciones legales y de uso.
</p>
</li>


<li id="<? echo "q$q";$q++;?>">
<h4>¿Dónde podemos seguir la evolución de los cambios de roséame?</h4>
<p>En <a href="https://github.com/roseame/roseame_v.1.0/">GitHub</a>.</p>
</li>
...
<p>Esto acaba de empezar, lo intentaremos primero con una cuenta AdSense y ya veremos que pasa en el futuro.</p>
</li>
